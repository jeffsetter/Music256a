# `Rollercoaster` : A Quick Look at Graphics Concepts
...
* Build the program.
    * On OSX, open up `rollercoaster.xcodeproj` and build the target for "*rollercoaster Release > My Mac (64 bit)*" (or Debug, or 32-bit, etc.)
