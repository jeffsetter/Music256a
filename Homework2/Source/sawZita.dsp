process = vgroup("ZitaReverb",environment{declare name "EK_Verb2";
declare version "0.1";
declare author "CL GRAME and modified by Jeff Setter";
declare license "BSD";
...
*/
freq1 = hslider("freq1",440,20,20000,0.01) : si.smoo;
freq2 = hslider("freq2",440,20,20000,0.01) : si.smoo;
gain = hslider("gain",1,0,1,0.01) : si.smoo;
gate = button("gate") : si.smoo;

process =hgroup("saw", (os.oscsin(freq1)+os.oscsin(freq2))/2 * gain * gate<:zita_rev3:>_);

zita_rev3(x,y) = zita_rev1_stereo4(rdel,f1,f2,t60dc,t60m,fsmax,x,y) : out_eq
with {
	//Reverb parameters:
	t60dc = hslider("decay", 1.5, 0.5, 8, 0.01):si.smooth(0.999):min(6):max(0.5);
	t60m = t60dc;
